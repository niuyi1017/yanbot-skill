...
> 用对话直接查考研数据——院校、分数线、调剂、公告；并支持对比/分析/出报告。

---

## 安装研bot skill后，你可以做什么？

把研bot接入了你的 AI 助手。安装后，直接中文对话就能查：
...
直接把下面这段话发给 AI Agent （例如 WorkBuddy【推荐】、Claude Desktop、Cursor、codex 等）：
